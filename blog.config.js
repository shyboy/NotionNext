...
const BLOG = {
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN','en-US','zh-HK','zh-TW','ja-JP' // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '545902304@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/2827794', // B站主页
  ...
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzI5MTA4Njk1MA==#wechat_redirect', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【xxxxxx】==#wechat_redirect
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-KM3FB18RDN', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
